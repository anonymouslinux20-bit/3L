...
const products = [
  {
    id: 1, name: 'Special Kinalas', category: 'Kinalas',
    emoji: '🍜', price: '₱85', tag: 'Best Seller',
  ...
  {
      id: 2, name: 'Kinalas W/ Egg', category: 'Kinalas',
    emoji: '🌶️', price: '₱75', tag: 'Hot Pick',
  ...
  {
    id: 3, name: 'Regular Kinalas', category: 'Kinalas',
    emoji: '🍲', price: '₱60', tag: 'New',
  ...
  {
    id: 8, name: 'Turon', category: 'Merienda',
    emoji: '🍽️', price: '₱15', tag: null,
